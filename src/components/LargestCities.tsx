    ...
    <div>
        ...
        <div className='flex flex-col md:flex-row md:flex-wrap w-[80vw] md:w-auto'>
            {cities && cities.map((city, key) => {
                return (
                <div key={key} className='flex mb-3 pt-4 pb-4 pl-3 pr-3 mr-3 flex-row justify-between items-start space-x-12 w-auto rounded-sm cursor-pointer bg-stone-50 opacity-60 brightness-200 hover:opacity-100 active:opacity-100 focus:opacity-100 transition-all ease-in-out duration-150'>
                    <div className=''>
