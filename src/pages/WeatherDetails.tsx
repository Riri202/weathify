...
const handleDelete = (message: string) => {
  ...
  return (
      <div className='p-5 md:p-10 flex flex-col-reverse md:flex-row md:justify-between md:h-[130vh] backdrop-blur-sm'> 
      ...
      <div className=' md:p-20 w-auto'>
          ...
          <form onSubmit={handleSubmit} className='flex flex-col space-y-10 pt-10 pb-10 md:pb-0 md:pt-0'>
            <input type='text' placeholder='Enter Notes' onChange={handleChange} className=' focus-within:text-stone-200 outline-none bg-transparent border-0 border-b-2 border-b-stone-50 text-sm md:text-lg pl-3 pt-3'>
            </input>
      ...
      <div className='md:p-20 w-auto md:w-1/2 flex flex-col space-y-8'>
        ...
        <div className='flex flex-row justify-between space-x-4'>
          ...
          <div className='flex flex-col space-y-2'>
            <img src={`http://openweathermap.org/img/wn/${weatherData.icon}.png`} alt="weather-desc-icon" className='w-14 h-14 md:w-16 md:h-16 bg-stone-300 rounded-lg'/>
